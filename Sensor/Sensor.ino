...
const char* ssid     = "qifanyyyy";         // The SSID (name) of the Wi-Fi network you want to connect to
const char* password = "Namei123456";     // The password of the Wi-Fi network
const int pingPin = D4;                // PING))) Ultrasonic
WiFiClient client;                 // Initialize the Ethernet client object
char get_request[200];
char server[] = "10.0.0.155";
